...
func InitDB() {
	...
	*/
	...
	DB.Exec("UPDATE `service_sessions` SET `service_technician_ids` = JSON_ARRAY() WHERE `service_technician_ids` IS NULL")
	...
	DB.Exec("UPDATE `service_sessions` SET `start_confirmed_technician_ids` = JSON_ARRAY() WHERE `start_confirmed_technician_ids` IS NULL")

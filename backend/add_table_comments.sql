...
-- =============================================
-- 删除 cards 表的外键
ALTER TABLE `cards` DROP FOREIGN KEY `fk_cards_user`;
ALTER TABLE `cards` DROP FOREIGN KEY `fk_cards_merchant`;

-- 删除 usages 表的外键
ALTER TABLE `usages` DROP FOREIGN KEY `fk_usages_card`;
ALTER TABLE `usages` DROP FOREIGN KEY `fk_usages_merchant`;

-- 删除 appointments 表的外键
ALTER TABLE `appointments` DROP FOREIGN KEY `fk_appointments_user`;
ALTER TABLE `appointments` DROP FOREIGN KEY `fk_appointments_merchant`;

-- 删除 notices 表的外键
ALTER TABLE `notices` DROP FOREIGN KEY `fk_notices_merchant`;
...
ALTER TABLE `cards` 
    ...
    ADD CONSTRAINT `fk_cards_merchant` FOREIGN KEY (`merchant_id`) REFERENCES `merchants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- usages 表外键
ALTER TABLE `usages` 
    ADD CONSTRAINT `fk_usages_card` FOREIGN KEY (`card_id`) REFERENCES `cards` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `fk_usages_merchant` FOREIGN KEY (`merchant_id`) REFERENCES `merchants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- appointments 表外键
ALTER TABLE `appointments` 
    ADD CONSTRAINT `fk_appointments_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ADD CONSTRAINT `fk_appointments_merchant` FOREIGN KEY (`merchant_id`) REFERENCES `merchants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- notices 表外键
ALTER TABLE `notices` 
    ADD CONSTRAINT `fk_notices_merchant` FOREIGN KEY (`merchant_id`) REFERENCES `merchants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

...
type Technician struct {
	...
	MerchantID            uint       `json:"merchant_id" gorm:"index;uniqueIndex:uidx_merchant_role_code;uniqueIndex:uidx_merchant_account;comment:商户ID（外键关联merchants表）"`
	ServiceRoleID         uint       `json:"service_role_id" gorm:"index;uniqueIndex:uidx_merchant_role_code;comment:客服类型ID（平台 service_roles）"`
	...
	ServiceStartConfirmed bool       `json:"service_start_confirmed" gorm:"-"`

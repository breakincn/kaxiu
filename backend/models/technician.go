...
type Technician struct {
	...
	MerchantID uint       `json:"merchant_id" gorm:"index;uniqueIndex:uidx_merchant_code;comment:商户ID（外键关联merchants表）"`
	...
	Account    string     `json:"account" gorm:"size:50;uniqueIndex;comment:登录账号（如js0001）"`

...
const merchantRoutes = [
  ...
  {
    path: '/merchant/service-sessions',
    name: 'MerchantServiceSessions',
    component: () => import('../views/merchant/ServiceSessions.vue')
  },
  {

<template>
  <div class="min-h-screen bg-white text-[#202124]">
    <div class="mx-auto max-w-[430px] px-3 pb-8 pt-2">
      ...
      <div class="-mx-3 -mt-px bg-white px-5 pb-0 pt-[0px] text-gray-900">
...
const headerMetricCards = computed(() => [
  ...
  },
  {
    ...
    icon: commissionIcon,
    cardClass: 'border border-[#f4d8ab] bg-[linear-gradient(90deg,#fdf2dd_0%,#fee2bc_100%)] shadow-[inset_0_1px_0_rgba(255,252,245,0.98),0_8px_20px_rgba(252,187,98,0.2)]',

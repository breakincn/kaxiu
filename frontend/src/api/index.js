...
export const cardApi = {
  ...
  getMultiServiceBookingSlots: (id) => api.get(`/user/cards/${id}/multi-service-booking-slots`),
  createMultiServiceBooking: (id, data) => api.post(`/user/cards/${id}/multi-service-bookings`, data),
  cancelMultiServiceBooking: (id, bookingId, data) => api.post(`/user/cards/${id}/multi-service-bookings/${bookingId}/cancel`, data || {}),
...
export const attendanceApi = {
  ...
  publishNextDaySchedule: (date) => api.post('/merchant/schedules/publish-next-day', null, { params: { date } }),
